...
def save_processed_locally(data: dict, source_type: str, filename:str) -> str:
    """
    Save parsedd chunk metadata as JOSN in <processedd_folder>/<source_type>/.
    """
    folder = os.path.join(settings.PROCESSED_DATA_DIR, source_type)
...
def process_file(file_path: str, filename: str, source_type: str):
    """
    Parse → chunk → save locally → embed the chunks → index in Qdrant.
    """
